...
Thanks for your interest in contributing to `configs` — Pilot Protocol shipped configurations — daemon/gateway templates + canonical network policy catalog.

## Quick start

```bash
git clone https://github.com/pilot-protocol/configs.git
cd configs
